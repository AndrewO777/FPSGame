...
public class LobbyManager : NetworkBehaviour
{
    ...
    private void Start()
    {
        lobbyUICanvas.SetActive(true); // Add this line to hide the lobby UI
    ...
    private void HandleGameStarted(object sender, LobbyEventArgs e)
{
    StartGameForClient();
}

    private void StartGameForClient()
{
    ...
    public async void UpdatePlayerName(string playerName)
    {
        ...
        if (joinedLobby != null)
        {
            try
            {
                ...
                Lobby lobby = await Lobbies.Instance.UpdatePlayerAsync(joinedLobby.Id, playerId, options);
                joinedLobby = lobby;
    ...
    public async void StartGame()
    {
        if (IsLobbyHost())
        {
            try
            {
                ...
                {
                    Debug.LogError("TestRelay.Instance is null.");
                    return;
                }
